...
import 'package:delivery_app/core/data_sources/remote_data_source/firebase/firebase_data_source.dart';
import 'package:delivery_app/features/uber_trips_history_feature/data/models/driver_model.dart';
...
import 'package:delivery_app/features/uber_trips_history_feature/domain/entities/trip_entity.dart';
import 'package:delivery_app/features/uber_trips_history_feature/domain/repositories/trip_history_repository.dart';
...
class TripHistoryRepositoryImpl implements TripHistoryRepository {
  ...
  Stream<List<TripHistoryModel>> tripHistoryStream(
    ...
    return firebaseNearByMeDataSource.collectionStream(
      ...
      sort: (lhs, rhs) => DateTime.parse(rhs.tripDate!)
          .compareTo(DateTime.parse(lhs.tripDate!)),
    );
  }
  ...
  @override
  Stream<List<TripEntity>> tripDriverStream(
      bool isHistory, String driverId, String? tripId) {
  ...
  @override
  Future<void> updateDriverAndTrip(
      TripEntity tripDriver, DriverModel driverModel, bool isDriver) async {
