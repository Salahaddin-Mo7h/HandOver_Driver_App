...
import 'package:delivery_app/features/uber_trip_feature/presentation/widgets/custom_elevated_button.dart';
                                  ...
                                  itemBuilder: (context, index) {
                                    return ListTile(
                                      ...
                                      trailing: CustomElevatedButton(
                                        onPressed: () async {
                                          print(
                                              "userToken------token-------->${BlocProvider.of<UserReqCubit>(context).tripDriverUpdated!.riderModel.userToken}");
