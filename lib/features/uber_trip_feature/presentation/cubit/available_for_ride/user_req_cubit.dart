...
import 'package:delivery_app/features/uber_profile_feature/presentation/getx/uber_profile_controller.dart';
import 'package:delivery_app/features/uber_trip_feature/domain/use_cases/driver_update_usecase.dart';
...
import 'package:delivery_app/features/uber_trips_history_feature/domain/use_cases/get_trip_history_usecase.dart';
import 'package:delivery_app/injection_container.dart' as di;
      ...
      await driverUpdateUseCase.repository.updateDriverAndTrip(
          TripEntity(
              ...
              RiderModel(
                  ...
                  userToken: tripDriver.riderModel.userToken)),
          DriverModel(
            is_online: false,
            driver_id: driverId,
